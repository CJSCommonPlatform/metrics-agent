...
public class ArtemisAgentTest {
    ...
    private Object newQueueInstance(final String destinationName) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
    ...
    private static class TransformingClassLoader extends ClassLoader {
        ...
        public Class<?> loadClass(String name) throws ClassNotFoundException {
            if (name.equals(className)) {
                byte[] byteBuffer = ArtemisAgent.instrumentedByteCodeOf(className.replace('.', '/'));
